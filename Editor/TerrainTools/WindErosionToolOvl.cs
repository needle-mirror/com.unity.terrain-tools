...
{
    internal class WindErosionToolOvl : TerrainToolsPaintTool<WindErosionToolOvl>
    {
        ...
        static void SelectShortcut(ShortcutArguments args) {
            ...
            context.SelectPaintToolWithOverlays<WindErosionToolOvl>();                                                  // set active tool
        ...
        {
            get { return (int) ToolIndex.SculptIndex.WindErosion; }
        }
