...
{
    internal class TwistHeightToolOvl : TerrainToolsPaintTool<TwistHeightToolOvl>
    {
        ...
        static void SelectShortcut(ShortcutArguments args)
        {
            ...
            context.SelectPaintToolWithOverlays<TwistHeightToolOvl>();
            TerrainToolsAnalytics.OnShortcutKeyRelease("Select Twist Tool");
        }
#endif
        public override string OnIcon => "Packages/com.unity.terrain-tools/Editor/Icons/TerrainOverlays/Twist_On.png";
        ...
        {
            get { return (int) ToolIndex.SculptIndex.Twist; }
        }
