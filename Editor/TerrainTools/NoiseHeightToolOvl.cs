...
{
    internal class NoiseHeightToolOvl : TerrainToolsPaintTool<NoiseHeightToolOvl>
    {
        ...
        static void SelectShortcut(ShortcutArguments args)
        {
            ...
            context.SelectPaintToolWithOverlays<NoiseHeightToolOvl>();                                                                        // set active tool
        ...
        {
            get { return (int) ToolIndex.SculptIndex.Noise; }
        }
