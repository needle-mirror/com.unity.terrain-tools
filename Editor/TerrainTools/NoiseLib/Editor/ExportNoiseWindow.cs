...
namespace UnityEditor.TerrainTools
{
    ...
    internal class ExportNoiseWindow : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            m_exportMode = (ExportMode)EditorGUILayout.EnumPopup(Styles.textureType, m_exportMode);
        ...
        private static class Styles
        {
            ...
            public static GUIContent textureType = EditorGUIUtility.TrTextContent("Texture Type");
