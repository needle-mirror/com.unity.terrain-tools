...
{
    internal class PinchHeightToolOvl : TerrainToolsPaintTool<PinchHeightToolOvl>
    {
        ...
        static void SelectShortcut(ShortcutArguments args)
        {
            ...
            context.SelectPaintToolWithOverlays<PinchHeightToolOvl>();                                                  // set active tool
            TerrainToolsAnalytics.OnShortcutKeyRelease("Select Pinch Tool");
        }
#endif
        public override string OnIcon => "Packages/com.unity.terrain-tools/Editor/Icons/TerrainOverlays/Pinch_On.png";
        ...
        {
            get { return (int) ToolIndex.SculptIndex.Pinch; }
        }
