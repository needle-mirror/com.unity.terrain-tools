...
{
    internal class SlopeFlattenToolOvl : TerrainToolsPaintTool<SlopeFlattenToolOvl>
    {
        ...
        static void SelectShortcut(ShortcutArguments args)
        {
            ...
            context.SelectPaintToolWithOverlays<SlopeFlattenToolOvl>();
        ...
        {
            get { return (int) ToolIndex.SculptIndex.FlattenSlope; }
        }
