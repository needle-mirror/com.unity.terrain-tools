...
{
    internal class BridgeToolOvl : TerrainToolsPaintTool<BridgeToolOvl>
    {
        ...
        static void SelectShortcut(ShortcutArguments args) {
            ...
            context.SelectPaintToolWithOverlays<BridgeToolOvl>();                                                  // set active tool
        ...
        [System.Serializable]
        internal class BridgeToolSerializedProperties
        {
        ...
        internal BridgeToolSerializedProperties bridgeToolProperties = new BridgeToolSerializedProperties();

        public override int IconIndex
        {
            get { return (int) ToolIndex.SculptIndex.Bridge; }
        }
