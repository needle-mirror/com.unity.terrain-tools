...
![Terrain layers tools](images/4-32-toolbox-terrain-layers-01.png)
...
![Palette preset](images/4-32-toolbox-terrain-layers-03.png)
...
The list order affects which channel and splatmap a layer uses. For example, the image below displays the respective splatmap and channel each layer uses when you assign them to a Terrain.

![Material layer palette](images/4-32-toolbox-terrain-layers-04.png)
...
![Terrain layer palette order](images/4-32-toolbox-terrain-layers-05.png)
