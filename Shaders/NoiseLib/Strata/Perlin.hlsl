...
#ifndef UNITY_TERRAIN_TOOL_NOISE_StrataPerlin_INC
#define UNITY_TERRAIN_TOOL_NOISE_StrataPerlin_INC
...
float noise_StrataPerlin_Raw( float pos, StrataFractalInput fractalInput )
{
    float prev = 0;
    float n = 0;
...
float noise_StrataPerlin_Raw( float2 pos, StrataFractalInput fractalInput )
{
    float prev = 0;
    float n = 0;
...
float noise_StrataPerlin_Raw( float3 pos, StrataFractalInput fractalInput )
{
    float prev = 0;
    float n = 0;
...
float noise_StrataPerlin_Raw( float4 pos, StrataFractalInput fractalInput )
{
    float prev = 0;
    float n = 0;
...
/*=========================================================================
    ...
    StrataPerlin Noise Functions - Fractal, Warped

=========================================================================*/

float noise_StrataPerlin( float pos, StrataFractalInput fractalInput )
{
    float prev = 0;
    ...
    {
        float q = noise_StrataPerlin_Raw( pos + fractalInput.warpOffsets.x, fractalInput );
        prev = pos;
...
float noise_StrataPerlin( float2 pos, StrataFractalInput fractalInput )
{
    float2 prev = 0;
    ...
    for ( float i = 0; i < warpIterations; ++i )
    {
        float2 q = float2( noise_StrataPerlin_Raw( pos, fractalInput ),
                           noise_StrataPerlin_Raw( pos + fractalInput.warpOffsets.xy, fractalInput ) );
        prev = pos;
...
float noise_StrataPerlin( float3 pos, StrataFractalInput fractalInput )
{
    float3 prev = 0;
    ...
    for ( float i = 0; i < warpIterations; ++i )
    {
        float3 q = float3( noise_StrataPerlin_Raw( pos.xyz, fractalInput ),
                    noise_StrataPerlin_Raw( pos.xyz + fractalInput.warpOffsets.xyz, fractalInput ),
                    noise_StrataPerlin_Raw( pos.xyz + float3( fractalInput.warpOffsets.x, fractalInput.warpOffsets.y, 0 ), fractalInput ) );
        prev = pos;
        pos = pos + fractalInput.warpStrength * q;
    }
...
float noise_StrataPerlin( float4 pos, StrataFractalInput fractalInput )
{
    float h = noise_StrataPerlin_Raw( pos, fractalInput );
...
#endif // UNITY_TERRAIN_TOOL_NOISE_StrataPerlin_INC